...
namespace Squirrel.Update
{
    ...
    class Program : IEnableLogger
    {
            ...
            */
            ...
            using (Disposable.Create(() => animatedGifWindowToken.Cancel())) {
                ...
                case UpdateAction.Install:
                    ...
                    Install(opt.silentInstall, progressSource, opt.parallelDownloadLimit, Path.GetFullPath(opt.target), opt.installationPath).Wait();
        ...
        public async Task Install(bool silentInstall, ProgressSource progressSource, int parallelDownloadLimit, string sourceDirectory = null, string installationPath = null)
        {
            ...
            using (var mgr = new UpdateManager(sourceDirectory, ourAppName, installationPath, parallelDownloadLimit: parallelDownloadLimit)) {
